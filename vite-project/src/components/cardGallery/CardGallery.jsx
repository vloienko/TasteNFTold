...
const CardGallery = () => {
   return (
      <div className="card-gallery">
         ...
         <Card img={cardImg_6} icon={iconImg_1} user={userImg_6} ></Card>
         <Card img={cardImg_7} icon={iconImg_2} user={userImg_7} ></Card>
         <Card img={cardImg_8} icon={iconImg_1} user={userImg_8} ></Card>
      </div>
   );
}
